    ...
    <div className="w-full h-16 bg-[#232428] p-3 relative">
      ...
      {openSettings && (
        <div className="absolute w-full h-40 bg-[#1E1F22] bottom-16 right-0 shadow-2xl rounded-lg flex flex-col">
          ...
          <div className="flex-1 flex flex-col justify-center px-2 md:px-6 py-3">
            <button
              onClick={() => navigate("/profile")}
              className=" w-full py-3 bg-[#2B2D31] hover:bg-[#3A3C41] text-white !text-xs md:text-base font-semibold rounded-md text-center transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#5D5F63] focus:ring-offset-2"
            >
              Manage Account
            </button>
          </div>
