  ...
  return (
    ...
    >
      <div className="flex justify-center items-center gap-4">
        ...
        <div>
        <h3 className="text-sm md:text-md text-white font-medium">{item.username}</h3>
        {
          activeTopBarMenu !== "all" && (
      ...
      <div className="flex gap-2">
        <div className="w-8 h-8 md:w-12 md:h-12 flex items-center justify-center rounded-full bg-[#1E1F22]  transition-all">
          <IoChatbubble className="text-gray-300 text-base  md:text-2xl cursor-pointer hover:text-white" />
        </div>
        <div
          onClick={(e) => {
            e.stopPropagation();
          ...
          className="w-8 h-8 md:w-12 md:h-12 flex items-center justify-center rounded-full bg-[#1E1F22]  transition-all"
        >
          <IoCloseSharp className="text-gray-300 text-base md:text-2xl cursor-pointer hover:text-white" />
        </div>
      </div>
    </div>
  );
